module.exports = function({ api, models }) {
	...
	logger(`${api.getCurrentUserID()} - [ ${global.config.PREFIX} ] • ${(!global.config.BOTNAME) ? "Simple Manga Network Messenger Bot, code by Team MiraiV2 & remaster by Dragonx943" : global.config.BOTNAME}`, "[ Thông tin Bot ]");
