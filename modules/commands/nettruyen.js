...
module.exports.config = {
	...
	for (var i = await got("https://www.nettruyenplus.com/tim-truyen?keyword=" + encodeURIComponent(r.join(" "))), o = cheerio.load(i.body), s = o("#ctl00_divCenter").find(".Module-170 > div > div > div > div > figure > div > a"), d = [], c = 0; c < s.length; c++) {
		...
		case "read":
			...
			var w, x = async function(e) {
				await axios({
					...
					responseType: "stream",
					headers: {
						Referer: "http://www.nettruyenplus.com/",
